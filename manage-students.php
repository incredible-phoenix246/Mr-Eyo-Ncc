...
<?php $cnt=$cnt+1;}} ?>
                                        ...
                                        <button id="export-button" onclick="exportData()" style="background-color: #007bff; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;">Export</button>
                                                <!-- /.col-md-12 -->
                                            </div>
                                        </div>
                                    </div>
        ...
        function exportData() {
            ...
            // Create a hidden input to pass a flag to the server
            var input = document.createElement('input');
            input.type = 'hidden';
            input.name = 'export_flag';
            input.value = 'true';
